...
1. Commit initial code to the branch (be sure to replace all refernces to graphql-merge-unmerge, and remove these instructions from the README)
...
```ts
import add from 'graphql-merge-unmerge';
